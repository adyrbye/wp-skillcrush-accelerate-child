...
function create_custom_post_types() {
    register_post_type( 'case_studies', //assigns a unique name
        array( //defines settings (many more options available)
            'labels' => array(
                'name' => __( 'Case Studies' ), //human-readable name, plural
                'singular_name' => __( 'Case Study' ) //human-readable name, singular
            ),
            'public' => true,
            'has_archive' => true, //ensures posts are archived
            'rewrite' => array( 'slug' => 'case-studies' ), //defines URL slug for archive
        )
    );
